...
import { BoxProps } from '@mui/material';  // Assuming you are using Material-UI
import { useWalletBalances } from './useWalletBalances'; // Assuming this is a custom hook
import WalletRow from './WalletRow'; // Assuming this is your custom component
